...
![alt text](check-service.png)

#### 2. Check Web Pod

![alt text](check-pod.png)
...
![alt text](check-worker-node-status-1.png)
![alt text](check-worker-node-status-2.png)
...
![alt text](check-certifications.png)
