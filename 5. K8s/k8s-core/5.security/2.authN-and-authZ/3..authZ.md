...
```bash
--authorization-mode=Node,RBAC,Webhook #AlwaysAllow,AlwaysDeny
```
...
| ------------------ | ------------------------------------------------------ | --------------------------------- |
| 1️⃣ **Node**        | Special authorizer for kubelets                        | Node-to-API communication         |
| 2️⃣ **ABAC**        | Attribute-Based Access Control (deprecated)            | Legacy static rules via JSON      |
| 3️⃣ **RBAC**        | Role-Based Access Control (default in modern clusters) | Fine-grained permissions          |
| 4️⃣ **Webhook**     | External API for dynamic authorization decisions       | Integrate with enterprise systems |
| 5️⃣ **AlwaysAllow** | Allows all requests (unsafe, testing only)             | Development                       |
| 6️⃣ **AlwaysDeny**  | Denies all requests (testing only)                     | Development                       |
...
## 1️⃣ **Node Authorization (for Kubelets)**

<div align="center" style="background-color:#F2F2F2; border-radius: 10px; border: 2px solid">
  <img src="image/1763122991558.png" alt="Ingress and Egress Traffic" style="width: 80%">
</div>
...
<div align="center" style="background-color:#F2F2F2; border-radius: 10px; border: 2px solid">
  <img src="image/1763122521519.png" alt="Ingress and Egress Traffic" style="width: 80%">
</div>

---

## 3️⃣ **RBAC — The Primary Authorizer**

<div align="center" style="background-color:#F2F2F2; border-radius: 10px; border: 2px solid">
  <img src="image/1763122540365.png" alt="Ingress and Egress Traffic" style="width: 80%">
</div>
...
<div align="center" style="background-color:#F2F2F2; border-radius: 10px; border: 2px solid">
  <img src="image/1763122612937.png" alt="Ingress and Egress Traffic" style="width: 80%">
</div>
