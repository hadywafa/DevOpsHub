...
> “A security camera + intrusion detection system for your containers.”
...
flowchart TD
    A["☸️ Kubernetes"]
    B["📦 Pod Runtime Activity"]
    C["🕵️ Falco (eBPF)<br>Monitors Syscalls"]
    D["📜 Applies Falco Rules"]
    E["🚨 Alerts / Actions"]
...
### 1️⃣ Container spawning a shell
...
### 3️⃣ Suspicious outbound network call
...
### 1️⃣ Install Falco as Systemd Service
...
### 2️⃣ Install Falco as Kubernetes DaemonSet (use Helm)
...
## 🛡️ **Typical DevSecOps Workflow**

- 1️⃣ Build image -> Scan with Trivy
- 2️⃣ Validate YAML -> KubeLinter
- 3️⃣ Enforce policies -> OPA/Gatekeeper
- 4️⃣ Deploy
- 5️⃣ Monitor runtime -> Falco
- 6️⃣ Incident Response -> Alerting / dashboards
