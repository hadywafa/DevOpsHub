# 🛡️ **Security Context in K8s Pods**
...
<div align="center" style="background-color:#F1F1F1; border-radius: 10px; border: 2px solid">
  <img src="image/1763158718278.png" alt="OpenSSL" style="width: 80%">
</div>
...
spec:
  securityContext:
    seccompProfile:
      type: Localhost
      localhostProfile: profiles/<profile-name>
```
