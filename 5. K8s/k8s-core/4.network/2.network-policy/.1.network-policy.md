...
Here’s the structure of a typical NetworkPolicy:
...
> Notes:
>
> - There is no kubectl create command for NetworkPolicies.
> - so you need to memorize it or see the docs
> - [Declaring a NetworkPolicy](https://kubernetes.io/docs/concepts/services-networking/network-policies/)
...
> 🚨 ingress pr egress will be affect only of you mention it in `policyTypes` Section in your NetworkPolicy yaml file.
...
### 4️⃣ Allow outgoing (Egress) DNS + API traffic
...
## 🔴 **Advanced: Combine with Namespaces**
