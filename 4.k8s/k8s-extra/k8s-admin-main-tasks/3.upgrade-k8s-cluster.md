...
2. [🛠️ Pre-Upgrade Preparation](#2)
   - [🔄 Changing the Package Repository](#2.1)
   - [📦 Review Release Notes](#2.2)
   - [💾 Backup Your Cluster](#2.3)
   - [🔧 Test the Upgrade](#2.4)
   - [🔗 Update Dependencies](#2.5)
3. [🏗️ Upgrade Control Plane (Master Nodes)](#3)
   - [1. Upgrade `kubeadm`](#3.1)
   - [2. Plan the Upgrade](#3.2)
   - [3. Apply the Upgrade](#3.3)
   - [4. Upgrade `kubelet` and `kubectl`](#3.4)
   - [5. Verify Control Plane Components](#3.5)
4. [🔧 Upgrade Worker Nodes](#4)
   - [1. Drain the Node](#4.1)
   - [2. Upgrade `kubeadm`, `kubelet`, and `kubectl`](#4.2)
   - [3. Uncordon the Node](#4.3)
