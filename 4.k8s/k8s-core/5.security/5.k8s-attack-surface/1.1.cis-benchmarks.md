...
2. Under **Server Software → Virtualization**, select **Kubernetes**.
...
- **Failed Controls** → Details of issues
- **Remediation Steps** → Commands or configs to fix
...
✅ After fixing, re-run CIS-CAT to verify improvement.
...
### 🧩 **A. Download Kubernetes Benchmark**
...
### 🧩 **B. Install CIS-CAT (Pro Version Recommended)**
...
### 🧱 **Common K8s CIS Controls to Practice**
