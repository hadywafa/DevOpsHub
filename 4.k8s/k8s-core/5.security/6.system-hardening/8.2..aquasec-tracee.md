# 🕵️‍♂️ **Tracee by AquaSecurity — Full Picture (2025 CKS)**
...
## 📥 **Installation (Simplest Way — CKS-Compatible)**
...
```bash
kubectl apply -f https://raw.githubusercontent.com/aquasecurity/tracee/main/deploy/daemonset/tracee.yaml
```
...
## 🔥 Top 10 Attacks Tracee Detects (Important for Exam)
