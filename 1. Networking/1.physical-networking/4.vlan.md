...
- With and without VLAN
  ![alt text](lan-vs-vlan.png)

- Connect Multiple LANs and keep them separated for security and performance reasons
  ![alt text](<Separate LANs.gif>)
  ![alt text](VLANs.gif)

- Routing between VLANs with a router
  ![alt text](<VLANs routing with router.gif>)

- Multiple same VLANs on a multiple switches
  ![alt text](native-vlan.gif)
  ![alt text](multi-vlans.png)

## How VLAN works?

![alt text](<VLANs per port.gif>)
...
- `Normal Ethernet Frame Structure`
  ![alt text](normal-eth-frame-structure.png)
...
- `VLAN Ethernet Frame Structure`
  ![alt text](vlan-eth-frame-structure.png)
