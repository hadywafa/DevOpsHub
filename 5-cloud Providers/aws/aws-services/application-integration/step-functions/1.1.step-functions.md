...
| --------------- | ---------------------------------------------------------------------------------------------- |
| **⏭️ Pass**     | 1. Passes data without performing any action. 2. it pushes input to output                     |
| **🛠️ Task**     | 1. Calls AWS services like Lambda, DynamoDB, S3, etc. 2. it takes an input and produce output. |
