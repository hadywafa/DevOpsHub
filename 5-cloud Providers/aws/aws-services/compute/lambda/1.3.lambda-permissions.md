...
✅ **Managing Lambda Execution Roles** (IAM roles that grant access to AWS services)  
✅ **Lambda Invoke Resource Policies** (Permissions for other services or accounts to invoke your function)
