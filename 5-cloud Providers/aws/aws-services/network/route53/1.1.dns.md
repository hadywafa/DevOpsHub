...
- **DNS Records**: Zone apex domains typically use **A records** to point directly to an IP address. Unlike subdomains, they cannot use **CNAME records** due to DNS restrictions, though alternatives like **ALIAS** or **ANAME records** can serve similar purposes.
