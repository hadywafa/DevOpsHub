...
![alt text](symantic-versioning.png)
...
![alt text](problem-without-caching.png)
![alt text](artifact-vs-cache-1.png)
![alt text](artifact-vs-cache-2.png)
![alt text](distributed-cache-problem.png)
![alt text](distributed-cache-solution.png)
...
![alt text](junit-test-report-inside-gitlab.png)
